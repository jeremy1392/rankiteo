...
if __name__ == "__main__":
    ...
    for breach_type in breach_types:
        ...
        adjusted_prob = combined_prob*(math.exp(1 - args.security_score / 1000) / 1.22)
    ...
    results_df.to_csv('breach_severity_predictions_v0.2.csv', index=False)

    print("Results have been saved to breach_severity_predictions_v0.2.csv")
