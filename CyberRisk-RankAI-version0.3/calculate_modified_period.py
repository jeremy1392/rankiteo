...
def calculate_modified_period(policy_length_months, base_period=12, base_date='2024-12-31'):
    """
    ...
    base_period (int): The base period (e.g., 12 for the end date of 2024-12-31).
    base_date (str): The base date in 'YYYY-MM-DD' format (default is '2024-12-31').
